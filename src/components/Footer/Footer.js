        ...
        <div>
            <footer className="footer p-10 bg-neutral text-neutral-content">
                <div className='grid grid-cols-1 lg:grid-cols-2'>
                    <img src="https://i.ibb.co/YbRVq70/footer.png" alt="" className="max-w-sm rounded-lg shadow-2xl w-36" />
                    <p className='mt-8'>Twist Quiz <br /> Copyright © 2023 coming soon !!!</p>
                </div>
                <div>
