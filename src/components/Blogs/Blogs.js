...
const Blogs = () => {
    return (
        <div className='bg-violet-800 rounded-3xl lg:m-20 m-2  p-16 '>

            <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box mx-2 lg:mx-32  my-6">
            ...
            <div tabIndex={0} className="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box mx-2 lg:mx-32 ">
                <div className="collapse-title text-xl font-medium">
